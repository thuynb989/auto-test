...
class SearchResultPage(BasePage):
    ...
    _LANGUAGE_CHECKBOX = '//span[text()="{language}"]/preceding-sibling::div//i'
    _ITEMS_PER_PAGE = '//div[@data-component-type="s-search-result"]'
    ...
    def scroll_to_language_check_box(self, language: str) -> None:
        self.scroll_to_element(self._LANGUAGE_CHECKBOX, 20, language=language)
    ...
    def get_number_result_in_result_search_label(self) -> int:
        ...
        number_result = result_search_label.split(" ")[-3].replace(",", "")
